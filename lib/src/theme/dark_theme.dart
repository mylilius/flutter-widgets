...
class DarkTheme extends ColorPalette {
  static const String _primary = "2E7DDE";
  static const String _secondary = "D9CB9E";
  static const String _darkBackground = "202122";
  ...
  static const String _brightness = 'dark';

  DarkTheme() : super(_primary, _secondary, _darkBackground, _lightBackground, _accent, _green, _red, _brightness);
